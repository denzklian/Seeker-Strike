...
if image and image.strip() != "":
    img_name_downloaded = utils.downloadImageFromUrl(image, 'template/whatsapp_redirect/images/')
    if img_name_downloaded:
        ...
        try:
            shutil.copyfile(image, 'template/whatsapp_redirect/images/{}'.format(possible_img_name))
